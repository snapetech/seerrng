...
This page covers certificates used by services that SeerrNG connects to, such
as Plex, Radarr, or Sonarr. To serve SeerrNG itself over HTTPS, see
[Built-in HTTPS and HTTP authentication modes](/using-seerr/advanced/built-in-tls).
